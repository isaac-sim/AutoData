...
from isaac_autodata_core.autonomous.hdf5_validation import hdf5_episode_count
    ...
    def _validate_staged_dataset(
        ...
        *,
        ...
        try:
            ...
            episode_count = hdf5_episode_count(descriptor, kind=kind)
...
def _probe_output_filesystem(staging_fd: int, parent_fd: int) -> None:
    ...
    try:
        ...
        os.fsync(descriptor)
        if hdf5_episode_count(descriptor, kind="filesystem probe") != 0:
