...
from isaac_autodata_core import transform as _transform
...
# Compatibility exports for callers that imported transform helpers from this legacy module.
IDENTITY_MATRIX4 = _transform.IDENTITY_MATRIX4
matrix4_error = _transform.matrix4_error
matrix4_inverse = _transform.matrix4_inverse
matrix4_multiply = _transform.matrix4_multiply
