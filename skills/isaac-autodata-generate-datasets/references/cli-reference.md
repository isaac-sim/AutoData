...
All commands run inside the Isaac AutoData container (repo mounted at
`/workspaces/isaac_autodata`, `python` aliased to Isaac Sim's interpreter). Grounded in the
