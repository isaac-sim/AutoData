...
"""Unit tests for :mod:`autodata_core.waypoint` (the non-async data structures)."""

import torch

import pytest

from autodata_core.waypoint import Waypoint, WaypointSequence, WaypointTrajectory
