...
"""Unit tests for the :mod:`autodata_interfaces.env.env_profile` schema.
...
from autodata_interfaces.env.env_profile import EnvironmentProfile, validate_profile_dict
