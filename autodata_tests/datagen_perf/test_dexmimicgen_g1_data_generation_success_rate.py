...
"""Data-generation success-rate perf test for the G1 loco-manipulation pick-place (DexMimicGen) task."""
...
from autodata_tests.utils.utils import assert_valid_dataset, read_generation_result
...
def test_dexmimicgen_g1_data_generation_success_rate():
...
if __name__ == "__main__":
    test_dexmimicgen_g1_data_generation_success_rate()
