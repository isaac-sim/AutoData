...
from autodata_interfaces.env.recorders import make_action_state_recorder_manager_cfg
...
def setup_env_config(
    ...
    :class:`~autodata_interfaces.tasks.generation_policy_spec.GenerationPolicy` rather than
